	...
	<head>
		...
		<style>
			body{
				color: #000;
				font-family: verdana;
				background-image: url("b2jpg.jpg");
			}
			#div1{
				color: #fff;
		...
		<div id="div1">
			...
			<div id="aboutus">
				...
				<div  align="left">
						...
						<center><h4>Shreyash Vishwakarma: Second Year CS Student, PHP Enthusiast and future Android Developer, Effective Juggler between College, Watching TV Series and PC games and Football (Basically What you call a SCHOLAR)</h4></center>
